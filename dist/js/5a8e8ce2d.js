...
(function (window, undefined) {
    ...
    K.options = {
        ...
        minChangeSize: 50,
        zIndex: 811213,
        items: ['code', 'justifyleft', 'justifycenter', 'justifyright', 'justifyfull', 'formatblock', 'fontname', 'fontsize', '|', 'forecolor', 'hilitecolor', 'bold', 'italic', 'underline', 'strikethrough', 'lineheight', '|', 'image', 'insertfile', 'hr', 'pagebreak', 'link', 'unlink'],
    ...
    _extend(KCmd, {
        ...
        insertimage: function insertimage(url, title, width, height, border, align) {
            title = _undef(title, '');
    ...
    _extend(KDialog, KWidget, {
        init: function init(options) {
            ...
            _each([{ btn: previewBtn, name: 'preview' }, { btn: yesBtn, name: 'yes' }, { btn: noBtn, name: 'no' }], function () {
                if (this.btn) {
...
KindEditor.plugin('code', function (K) {
    ...
    self.clickToolbar(name, function () {
        var lang = self.lang(name + '.'),
            html = ['<div style="padding:10px 20px;">', '<div class="ke-dialog-row">', '<select class="ke-code-type">', '<option value="javascript">JavaScript</option>', '<option value="html">HTML</option>', '<option value="css">CSS</option>', '<option value="php">PHP</option>', '<option value="perl">Perl</option>', '<option value="python">Python</option>', '<option value="ruby">Ruby</option>', '<option value="java">Java</option>', '<option value="">Other</option>', '</select>', '</div>', '<textarea class="ke-textarea" style="width:408px;height:260px;"></textarea>', '</div>'].join(''),
            ...
            yesBtn: {
                ...
                click: function click(e) {
                    ...
                    if (showLocal && showRemote && tabs && tabs.selectedIndex === 1 || !showRemote) {
                        ...
                        if (self.uploadImage) {
                            var localFile = K('.ke-form [name="imgFile"]', div)[0];
                            self.uploadImage(localFile, function (url) {
    ...
    K.extend(KSWFUpload, {
        init: function init(options) {
            ...
            var settings = {
                ...
                file_queue_error_handler: function file_queue_error_handler(file, errorCode, message) {
                    var errorName = '';
                    switch (errorCode) {
                ...
                upload_progress_handler: function upload_progress_handler(file, bytesLoaded, bytesTotal) {
                    var percent = Math.round(bytesLoaded * 100 / bytesTotal);
                    var progressbar = self.progressbars[file.id];
                    progressbar.bar.css('width', Math.round(percent * 80 / 100) + 'px');
                    progressbar.percent.html(percent + '%');
                },
                upload_error_handler: function upload_error_handler(file, errorCode, message) {
...
/* harmony default export */ __webpack_exports__["default"] = (KindEditor);
...
;(function register() {
    /* react-hot-loader/webpack */if (false) {
        if (typeof __REACT_HOT_LOADER__ === 'undefined') {
            ...
            __REACT_HOT_LOADER__.register(webpackExports, 'module.exports', "/Users/wangxiaolong/Desktop/work/my-items/cms-admin/src/containers/article/lib/kindeditor-all.js");return;
            ...
            /* eslint-enable no-restricted-syntax */if (!Object.prototype.hasOwnProperty.call(webpackExports, key)) {
                ...
                continue;
            }__REACT_HOT_LOADER__.register(namedExport, key, "/Users/wangxiaolong/Desktop/work/my-items/cms-admin/src/containers/article/lib/kindeditor-all.js");
        }
    }
})();
